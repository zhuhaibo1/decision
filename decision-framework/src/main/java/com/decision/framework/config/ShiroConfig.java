package com.decision.framework.config;
...
import com.decision.common.utils.security.CipherUtils;
import com.decision.common.utils.spring.SpringUtils;
import com.decision.framework.config.properties.PermitAllUrlProperties;
import com.decision.framework.shiro.realm.UserRealm;
import com.decision.framework.shiro.rememberMe.CustomCookieRememberMeManager;
import com.decision.framework.shiro.session.OnlineSessionDAO;
import com.decision.framework.shiro.session.OnlineSessionFactory;
import com.decision.framework.shiro.web.CustomShiroFilterFactoryBean;
import com.decision.framework.shiro.web.filter.LogoutFilter;
import com.decision.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import com.decision.framework.shiro.web.filter.csrf.CsrfValidateFilter;
import com.decision.framework.shiro.web.filter.kickout.KickoutSessionFilter;
import com.decision.framework.shiro.web.filter.online.OnlineSessionFilter;
import com.decision.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import com.decision.framework.shiro.web.session.OnlineWebSessionManager;
import com.decision.framework.shiro.web.session.SpringSessionValidationScheduler;
...
public class ShiroConfig
{
    ...
    {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("Decision");
