...
import com.decision.common.json.JSONObject;
import com.decision.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    {
        String[] array = { "Decision 1", "Decision 2", "Decision 3", "Decision 4", "Decision 5" };
        AjaxResult ajax = new AjaxResult();
